...
the organization. This includes team management and individual
contribution for mobile, Web, and embedded applications. Worked under
extremely tight deadlines while partnering with IDEO and our internal
team to produce native iOS and Android applications to launch a brand
new physical product centered social network
[LOOKS](http://lookspack.com). Continually guide development and
contribute to a Web portal for textile manufacturing industry members
to collaborate, find funding, and report utilizing Python/Django, and
VueJS. Created application for controlling Internet devices using
capacative sensing fabric. Created iOS application to assist with
